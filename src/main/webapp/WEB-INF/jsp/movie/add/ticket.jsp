        ...
        <div class="container mt-5">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">${ticketForm.session.movie.timeLength} <spring:message
                            code="movie.time.minutes"/></div>
                </div>
                ...
                <form:form class="form-horizontal" method="POST" modelAttribute="ticketForm"
                           action="${ticketActionUrl}">
                    <form:hidden path="id"/>
